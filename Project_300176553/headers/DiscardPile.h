...
/**
 * @file DiscardPile.h
 * @brief Contains the declaration of the DiscardPile class used in the card game.
 */
 ...
 *
 * The DiscardPile class manages discarded cards, providing functionalities to add cards,
 * pick up the top card, view the top card, print the pile, and save/load the pile from a file.
 */
...
public:
    ...
    /**
     * @brief Overloaded insertion operator to print the top card of the DiscardPile.
