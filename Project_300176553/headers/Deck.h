 ...
 *
 * The Deck class manages a collection of Card pointers, providing
 * functionalities to draw cards, save the deck, and load it from a file. It
 * uses polymorphism to handle different types of bean cards derived from the
 * Card base class.
 */
...
public:
   ...
   * if cards are deleted elsewhere, as multiple Decks may point to the same
   * cards.
   */
  Deck(const Deck &d);
