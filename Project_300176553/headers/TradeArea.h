...
/**
 * @class TradeArea
 * @brief Manages the trade area where cards are openly available for players to chain or leave for the next player.
 *
 ...
 * check if a card can be legally added, trade (remove) a card of a specific bean,
 * and get the number of cards in the trade area.
 */
class TradeArea
{
    std::list<Card *> tradeAr; /**< List holding pointers to cards in the trade area */
