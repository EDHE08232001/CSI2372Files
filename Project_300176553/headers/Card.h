...
public:
    /**
     * @brief Pure virtual function to get the number of cards required for a certain number of coins.
    ...
    /**
     * @brief Pure virtual function to print the card representation to an output stream.
     ...
     * @note This operator is defined as a member function, but it's generally better to overload operator<< as a non-member function.
     */
