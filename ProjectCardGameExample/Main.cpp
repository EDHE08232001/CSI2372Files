...
int main()
{
    ...
    while (deck->size() != 0)
    {
        ...
        std::cout << std::endl
                  << ">>>>>>>>>>> Do you want to pause and save the game ? (y/n)" << std::endl;
        std::cin >> user_input;
        if (user_input[0] == 'y')
        {
        ...
        { // proceed with the game
            for (int i = 0; i < MAX_NUM_PLAYER; i++)
            {
                ...
                std::cout << std::endl
                          << "> Playing topmost card from Hand (" << p->getHand()->top()->getName()[0] << ")" << std::endl;
                ...
                std::cout << std::endl
                          << "> Play top most card ? (y) or Discard card to Discard Pile? (n) " << std::endl;
                ...
                std::cout << std::endl
                          << ">>>> Drawing three cards from the deck to the trade area. " << std::endl
                          << std::endl;
